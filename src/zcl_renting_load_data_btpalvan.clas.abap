CLASS zcl_renting_load_data_btpalvan DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_btpalvan IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      lt_brands    TYPE TABLE OF zbrands_btpalvan,
      lt_cars      TYPE TABLE OF zcars_btpalvan,
      lt_customers TYPE TABLE OF zcustom_btpalvan.
    ...
    DELETE FROM zbrands_btpalvan.
    INSERT zbrands_btpalvan FROM TABLE  @lt_brands.

    SELECT *
    FROM zbrands_btpalvan
    INTO TABLE @lt_brands.

    out->write( sy-dbcnt && | | && 'elements has been inserted in zbrands_btpalvan' ).

    "Cars
    lt_cars = VALUE #(
        ( matricula = '1246GSA' marca = 'BMW' modelo = 'SERIE 4' color = 'BLANCO' motor = '2.5' potencia = '210' und_potecia = 'CV' combustible = 'GASOLINA' fecha_fabr = '20200418' puertas = '5' precio = '210'
            moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241231' )
        ( matricula = '2174FHF' marca = 'KIA' modelo = 'CEE''D' color = 'AZUL' motor = '4.2' potencia = '340' und_potecia = 'CV' combustible = 'GASOLINA' fecha_fabr = '20200617' puertas = '5' precio = '160'
            moneda = 'USD' alquilado = 'X' alq_desde = '20240801' alq_hasta = '20240831' )
        ( matricula = '2356FSF' marca = 'AUDI' modelo = 'A8' color = 'BLANCO' motor = '3.9' potencia = '140' und_potecia = 'CV' combustible = 'ELECTRIC' fecha_fabr = '20200304' puertas = '3' precio = '140'
            moneda = 'USD' alquilado = 'X' alq_desde = '20210701' alq_hasta = '20240708' )
        ( matricula = '2392JFH' marca = 'JEEP' modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor = '3.6' potencia = '176' und_potecia = 'CV' combustible = 'GASOLINA' fecha_fabr = '20200924' puertas = '5' precio = '160'
            moneda = 'USD' alquilado = 'X' alq_desde = '20240601' alq_hasta = '20241001' )
        ( matricula = '2837KFF' marca = 'MERCEDES' modelo = 'CLASE B' color = 'NEGRO' motor = '2.0' potencia = '200' und_potecia = 'CV' combustible = 'GASOLINA' fecha_fabr = '20200726' puertas = '5' precio = '160'
            moneda = 'USD' alquilado = 'X' alq_desde = '20240301' alq_hasta = '20240301' )
        ( matricula = '2837SUF' marca = 'MERCEDES' modelo = 'CLASE C' color = 'AMARILLO' motor = '3.0' potencia = '220' und_potecia = 'CV' combustible = 'GASOLINA' fecha_fabr = '20200614' puertas = '5' precio = '180'
            moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241206' )
        ( matricula = '2847JGH' marca = 'HONDA' modelo = 'CARENS' color = 'NEGRO' motor = '1.9' potencia = '180' und_potecia = 'CV' combustible = 'DIESEL' fecha_fabr = '20210716' puertas = '5' precio = '180'
            moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241206' )
        ( matricula = '29348KJ' marca = 'MINI' modelo = 'CABRIO' color = 'AMARILLO' motor = '2.0' potencia = '240' und_potecia = 'CV' combustible = 'ELECTRIC' fecha_fabr = '20200812' puertas = '3' precio = '150'
            moneda = 'USD' alquilado = 'X' alq_desde = '20241106' alq_hasta = '20241206' )
  ).

    DELETE FROM zcars_btpalvan.
    INSERT zcars_btpalvan FROM TABLE  @lt_cars.

    SELECT *
    FROM zcars_btpalvan
    INTO TABLE @lt_cars.

    out->write( sy-dbcnt && | | && 'elements has been inserted in zcars_btpalvan' ).
    ...
    DELETE FROM zcustom_btpalvan.
    INSERT zcustom_btpalvan FROM TABLE  @lt_customers.

    SELECT *
    FROM zcustom_btpalvan
    INTO TABLE @lt_customers.

    out->write( sy-dbcnt && | | && 'elements has been inserted in zcustom_btpalvan' ).

    "DATA agencies_cars TYPE TABLE FOR UPDATE zcars_btpalvan.

    "agencies_cars = VALUE #( ( agencyid = '700050' name = 'Some fancy new name' ) ).

    "MODIFY ENTITIES OF zcds_renting_btpalvan
    "ENTITY Cars
    "UPDATE FIELDS ( name )
    "WITH agencies_cars.
